...
---------------------- INPUT FILES ---------------------------------------------
"../data/ED_Light_SurgeInitLarge.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"Bipod_Decay_HD.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"Bipod_Decay_SD_Legacy.dat"   SubFile         - Name of file containing sub-structural input parameters (quoted string)
