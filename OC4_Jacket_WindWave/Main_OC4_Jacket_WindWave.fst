...
---------------------- INPUT FILES ---------------------------------------------
"../data_OF/ElastoDyn_PtfmMass_PtfmInertia_FlexTurbine.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../data_OF/InflowWind_A001.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../data_OF/NRELOffshrBsline5MW_OC4Jacket_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../data_OF/ServoDyn_None.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"OC4Jacket_WindWave_HD.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"OC4Jacket_WindWave_SD.dat"    SubFile         - Name of file containing sub-structural input parameters (quoted string)
