...
---------------------- INPUT FILES ---------------------------------------------
"SparPendulum_ED_NoPlatform_RefH.dat"      EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"SparPendulum_HD_ForH.dat"                               HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"SparPendulum_SD_RefH.dat"                               SubFile         - Name of file containing sub-structural input parameters (quoted string)
