...
---------------------- INPUT FILES ---------------------------------------------
"SparHanging_ED.dat"      EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"SparHangind_SD.dat"                               SubFile         - Name of file containing sub-structural input parameters (quoted string)
