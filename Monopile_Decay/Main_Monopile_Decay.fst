...
---------------------- INPUT FILES ---------------------------------------------
"ED_MonopileOnlySurgeInit.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"Monopile100_SubDyn.dat"    SubFile         - Name of file containing sub-structural input parameters (quoted string)
