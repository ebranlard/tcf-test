...
"SimpleTripod_FreeDecay_HD.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"SimpleTripod_FreeDecay_SD.dat"   SubFile         - Name of file containing sub-structural input parameters (quoted string)
