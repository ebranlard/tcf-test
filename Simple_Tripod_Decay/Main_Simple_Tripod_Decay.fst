...
"Simple_Tripod_Decay_HD.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"Simple_Tripod_Decay_SD.dat"   SubFile         - Name of file containing sub-structural input parameters (quoted string)
