...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
       ...
       0.0020   DT              - Recommended module time step (s)
...
---------------------- INPUT FILES ---------------------------------------------
"../data/ED_Light_SurgeInit.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"SimpleJacket_FreeDecay_HD.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"SimpleJacket_FreeDecay_SD.dat"   SubFile         - Name of file containing sub-structural input parameters (quoted string)
